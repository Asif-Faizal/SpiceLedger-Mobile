...
part of 'merchant_inventory_event.dart';
...
/// @nodoc
mixin _$MerchantInventoryEvent {
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is MerchantInventoryEvent);
}
...
/// @nodoc
class $MerchantInventoryEventCopyWith<$Res>  {
$MerchantInventoryEventCopyWith(MerchantInventoryEvent _, $Res Function(MerchantInventoryEvent) __);
}


/// Adds pattern-matching-related methods to [MerchantInventoryEvent].
extension MerchantInventoryEventPatterns on MerchantInventoryEvent {
...
class _Fetch implements MerchantInventoryEvent {
  const _Fetch();
...
@override
String toString() {
  return 'MerchantInventoryEvent.fetch()';
}
